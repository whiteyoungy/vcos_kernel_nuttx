...
begin_packed_struct struct note_common_s
{
...
begin_packed_struct struct note_suspend_s
{
...
/* This is the specific form of the NOTE_WAKEUP note */

begin_packed_struct struct note_wakeup_s
{
  struct note_common_s nwa_cmn; /* Common note parameters */
  pid_t wakeup_id;              /* Common note parameters */
} end_packed_struct;

/* This is the specific form of the NOTE_REACTIVATE note */

struct note_reactivate_s
{
  struct note_common_s nreact_cmn; /* Common note parameters */
};
...
begin_packed_struct struct note_irqhandler_s
{
...
#else
#  define sched_note_nowait()
#  define sched_note_reactivate(t)
#endif
