...
#ifdef CONFIG_NOTE_HANDSHAKE
/* This is the callback type used by nxsched_handshake() */

typedef CODE void (*nxsched_handshake_t)(FAR struct tcb_s *tcb,
                                         FAR void *arg);
#endif
...
#ifdef CONFIG_NOTE_HANDSHAKE
/****************************************************************************
 * Name: nxsched_handshake
 *
 * Description:
 *   Enumerate a task after an index and provide the TCB of each task to a
 *   user callback functions.
 *
 * Input Parameters:
 *   handler - The function to be called with the TCB of each task
 *   start_ndx - find a tcb after this index
 *
 * Returned Value:
 *   None
 *
