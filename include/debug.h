...
#ifdef CONFIG_DEBUG_MBOX_ERROR
#  define mboxerr       _err
#else
#  define mboxerr       _none
#endif

#ifdef CONFIG_DEBUG_MBOX_WARN
#  define mboxwarn      _warn
#else
#  define mboxwarn      _none
#endif

#ifdef CONFIG_DEBUG_MBOX_INFO
#  define mboxinfo      _info
#else
#  define mboxinfo      _none
#endif
...
#  define mboxerrdumpbuffer(m,b,n)  errdumpbuffer(m,b,n)
#  define mboxinfodumpbuffer(m,b,n) infodumpbuffer(m,b,n)
#else
#  define mboxerrdumpbuffer(m,b,n)
#  define mboxinfodumpbuffer(m,b,n)
#endif
