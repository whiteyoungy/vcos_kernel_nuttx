...
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_ONESHOT
#elif defined(CONFIG_WATCHDOG_AUTOMONITOR_BY_TIMER)
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_TIMER
#elif defined(CONFIG_WATCHDOG_AUTOMONITOR_BY_WDOG)
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_WDOG
#elif defined(CONFIG_WATCHDOG_AUTOMONITOR_BY_WORKER)
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_WORKER
#elif defined(CONFIG_WATCHDOG_AUTOMONITOR_BY_CAPTURE)
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_CAPTURE
#elif defined(CONFIG_WATCHDOG_AUTOMONITOR_BY_IDLE)
#define  WDT_NOTIFIER_ACTION CONFIG_WATCHDOG_AUTOMONITOR_BY_IDLE
#endif
/****************************************************************************
...
{
  wdt_notifier_call_chain(WDT_NOTIFIER_ACTION, NULL);
}
