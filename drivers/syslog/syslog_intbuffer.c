...
static __percpu_bss struct syslog_intbuffer_s g_syslog_intbuffer;
...
static inline void syslog_init_intbuffer(void)
{
  if (g_syslog_intbuffer.circ.base == NULL)
    {
      circbuf_init(&g_syslog_intbuffer.circ, g_syslog_intbuffer.buffer,
