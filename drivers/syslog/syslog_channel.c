...
MMAP_SHARE_VAR_INIT_SECTION volatile static spinlock_t g_lowputs_slock = SP_UNLOCKED;
# else
static __percpu_data mutex_t g_lowputs_lock = NXMUTEX_INITIALIZER;
...
#ifdef CONFIG_SCHU_RP_LOG
extern syslog_channel_t g_rplog_channel;
#endif
...
#    ifdef CONFIG_BMP
  ...
  irqstate_t flags = spin_lock_irqsave(&g_lowputs_slock);
#    else
...
#    ifdef CONFIG_BMP
  spin_unlock_irqrestore(&g_lowputs_slock, flags);
#    else
