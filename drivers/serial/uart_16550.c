...
static __percpu_bss char g_uart0rxbuffer[CONFIG_16550_UART0_RXBUFSIZE];
static __percpu_bss char g_uart0txbuffer[CONFIG_16550_UART0_TXBUFSIZE];
...
static __percpu_bss char g_uart1rxbuffer[CONFIG_16550_UART1_RXBUFSIZE];
static __percpu_bss char g_uart1txbuffer[CONFIG_16550_UART1_TXBUFSIZE];
...
static __percpu_bss char g_uart2rxbuffer[CONFIG_16550_UART2_RXBUFSIZE];
static __percpu_bss char g_uart2txbuffer[CONFIG_16550_UART2_TXBUFSIZE];
...
static __perpcu_bss char g_uart3rxbuffer[CONFIG_16550_UART3_RXBUFSIZE];
static __percpu_bss char g_uart3txbuffer[CONFIG_16550_UART3_TXBUFSIZE];
...
static __percpu_data uart_dev_t g_uart1port =
{
  .recv     =
  {
...
static __percpu_data uart_dev_t g_uart2port =
{
  .recv     =
  {
...
static __percpu_data uart_dev_t g_uart3port =
{
  .recv     =
  {
...
#if (defined(CONFIG_BOARD_ZEBU_ISP) || defined(CONFIG_BOARD_ZEBU_FSI) || defined(CONFIG_BOARD_ZEBU_NPUSCHED)) \
  && !defined(CONFIG_PLATFORM_EVB)
  u16550_serialout(priv, UART_DLM_OFFSET, 0);
  u16550_serialout(priv, UART_DLL_OFFSET, 1);
#else
  uint16_t div;
