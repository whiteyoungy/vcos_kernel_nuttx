...
static __percpu_bss unsigned long g_randint1;
#define g_randint1 this_cpu_var(g_randint1)
#if (CONFIG_LIBC_RAND_ORDER > 1)
static __percpu_bss unsigned long g_randint2;
#define g_randint2 this_cpu_var(g_randint2)
#if (CONFIG_LIBC_RAND_ORDER > 2)
static __percpu_bss unsigned long g_randint3;
#define g_randint3 this_cpu_var(g_randint3)
#endif
#endif
