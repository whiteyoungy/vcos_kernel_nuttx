...
static __percpu_bss struct posix_timer_s g_prealloctimers[CONFIG_PREALLOC_TIMERS];
...
#undef g_freetimers
volatile __percpu_bss sq_queue_t g_freetimers;
...
#undef g_alloctimers
volatile __percpu_bss sq_queue_t g_alloctimers;
