...
MMAP_SHARE_VAR_INIT_SECTION static spinlock_t  g_assert_lock = SP_UNLOCKED;
MMAP_SHARE_VAR_INIT_SECTION volatile uint32_t  g_assert_sync = 0xDEAD0000;
#endif
...
void dump_debug_bkpt_msg(uint32_t *regs)
{
  struct utsname name;
#ifdef CONFIG_SCHED_BACKTRACE
