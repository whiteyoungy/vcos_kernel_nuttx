...
static __percpu_bss spinlock_t g_sigaction_spin;
#define g_sigaction_spin this_cpu_var(g_sigaction_spin)

#if CONFIG_SIG_PREALLOC_ACTIONS > 0
static __percpu_bss sigactq_t  g_sigactions[CONFIG_SIG_PREALLOC_ACTIONS];
#define g_sigactions this_cpu_var(g_sigactions)
static __percpu_bss bool       g_sigactions_used = false;
