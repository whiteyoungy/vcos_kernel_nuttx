...
__percpu_bss sq_queue_t  g_sigfreeaction;
...
__percpu_bss sq_queue_t  g_sigpendingaction;
...
__percpu_bss sq_queue_t  g_sigpendingirqaction;
...
__percpu_bss sq_queue_t  g_sigpendingsignal;
...
__percpu_bss sq_queue_t  g_sigpendingirqsignal;
...
static __percpu_bss struct sigpool_s g_sigpool;
