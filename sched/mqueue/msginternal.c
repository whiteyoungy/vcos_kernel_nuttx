...
static __percpu_bss uint8_t             g_nmsgq; /* The number of groups of msgs array */
#define g_nmsgq            this_cpu_var(g_nmsgq)
static FAR __percpu_bss struct msgq_s **g_msgqs; /* The pointer of two layer file descriptors array */
...
#undef g_msgfreelist
__percpu_bss struct list_node g_msgfreelist;
