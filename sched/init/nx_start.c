...
#undef g_readytorun
__percpu_bss dq_queue_t g_readytorun;
...
FAR __percpu_bss struct tcb_s *g_running_tasks[CONFIG_SMP_NCPUS];
...
__percpu_bss dq_queue_t g_waitingforfill;
...
__percpu_bss dq_queue_t g_inactivetasks;
#define g_inactivetasks this_cpu_var(g_inactivetasks)

/* This is the value of the last process ID assigned to a task */

#undef g_lastpid
__percpu_bss volatile pid_t g_lastpid;
...
#undef g_pidhash
FAR __percpu_bss struct tcb_s **g_pidhash;
#define g_pidhash this_cpu_var(g_pidhash)
#undef g_npidhash
volatile __percpu_bss int g_npidhash;
...
__percpu_bss struct tasklist_s g_tasklisttable[NUM_TASK_STATES];
...
volatile __percpu_bss uint8_t g_nx_initstate;  /* See enum nx_initstate_e */
...
static __percpu_bss struct tcb_s g_idletcb[CONFIG_SMP_NCPUS];
