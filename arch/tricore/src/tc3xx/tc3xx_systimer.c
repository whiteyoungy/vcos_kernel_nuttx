/****************************************************************************
 * arch/tricore/src/tc3xx/tc3xx_systimer.c
 *
...
static int tc3xx_systimer_max_delay(struct oneshot_lowerhalf_s *lower,
                                      struct timespec *ts);
static int tc3xx_systimer_start(struct oneshot_lowerhalf_s *lower,
                                  oneshot_callback_t callback, void *arg,
                                  const struct timespec *ts);
static int tc3xx_systimer_cancel(struct oneshot_lowerhalf_s *lower,
                                   struct timespec *ts);
static int tc3xx_systimer_current(struct oneshot_lowerhalf_s *lower,
                                    struct timespec *ts);
...
static uint64_t
tc3xx_systimer_get_time(struct tc3xx_systimer_lowerhalf_s *priv)
{
  irqstate_t flags;
  uint64_t ticks;
...
static void
tc3xx_systimer_set_timecmp(struct tc3xx_systimer_lowerhalf_s *priv,
                             uint64_t value)
{
  irqstate_t flags;
                                  ...
                                  const struct timespec *ts)
{
  struct tc3xx_systimer_lowerhalf_s *priv =
    (struct tc3xx_systimer_lowerhalf_s *)lower;
...
/****************************************************************************
 * Name: tc3xx_systimer_initialize
 *
 * Description:
...
tc3xx_systimer_initialize(volatile void *tbase, int irq, uint64_t freq)
{
  struct tc3xx_systimer_lowerhalf_s *priv;
