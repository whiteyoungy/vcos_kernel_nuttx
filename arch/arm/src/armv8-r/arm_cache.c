...
{
  return MAX(cp15_icache_linesize(), l2cc_linesize());
}
...
{
  return MAX(cp15_icache_size(), l2cc_size());
}
...
{
  return MAX(cp15_dcache_linesize(), l2cc_linesize());
}
...
{
  return MAX(cp15_dcache_size(), l2cc_size());
}
