/****************************************************************************
 * arch/rh850/src/common/rh850_switchcontext.c
 *
  ...
  if (up_current_regs())
    {
       ...
       * Just copy the up_current_regs() into the OLD rtcb.
       */

      rh850_savecontext(rtcb);
