/****************************************************************************
 * arch/rh850/src/common/rh850_checkstack.c
 *
...
size_t up_check_tcbstack(struct tcb_s *tcb)
{
  ...
  size = rh850_stack_check((uintptr_t)tcb->stack_base_ptr,
                                      tcb->adj_stack_size);
...
{
  return rh850_stack_check((uintptr_t)g_intstackalloc,
