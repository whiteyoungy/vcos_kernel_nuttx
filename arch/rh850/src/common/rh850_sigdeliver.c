/****************************************************************************
 * arch/rh850/src/common/rh850_sigdeliver.c
 *
...
retry:
   ...
   * rh850_fullcontextrestore() is called, but that may not be necessary.
   */
