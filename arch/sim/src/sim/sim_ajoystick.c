...
static __percpu_bss int g_eventloop;
static __percpu_bss bool g_ajoy_valid;                  /* True: Sample data is valid */
static __percpu_bss struct ajoy_sample_s g_ajoy_sample; /* Last sample data */
static __percpu_bss ajoy_buttonset_t g_ajoy_buttons;    /* Last buttons set */

static __percpu_bss ajoy_handler_t g_ajoy_handler;      /* "Interrupt" handler */
static __percpu_bss void *g_ajoy_arg;                   /* Handler argument */
static __percpu_bss ajoy_buttonset_t g_ajoy_pset;       /* Set of press waited for */
static __percpu_bss ajoy_buttonset_t g_ajoy_rset;       /* Set of releases waited for */

#define g_eventloop this_cpu_var(g_eventloop)
#define g_ajoy_valid this_cpu_var(g_ajoy_valid)
#define g_ajoy_sample this_cpu_var(g_ajoy_sample)
#define g_ajoy_buttons this_cpu_var(g_ajoy_buttons)
#define g_ajoy_handler this_cpu_var(g_ajoy_handler)
#define g_ajoy_arg this_cpu_var(g_ajoy_arg)
#define g_ajoy_pset this_cpu_var(g_ajoy_pset)
#define g_ajoy_rset this_cpu_var(g_ajoy_rset)
/****************************************************************************
 * Private Functions
 ****************************************************************************/
