...
#undef g_textheap
#undef g_dataheap
static __percpu_bss struct mm_heap_s *g_textheap;
static __percpu_bss struct mm_heap_s *g_dataheap;
#define g_textheap this_cpu_var(g_textheap)
#define g_dataheap this_cpu_var(g_dataheap)
