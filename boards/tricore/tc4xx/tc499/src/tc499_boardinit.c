/****************************************************************************
 * boards/tricore/tc4xx/tc499/src/tc499_boardinit.c
 *
 ...
 *
 *   Logic in tc397_memory_initialize must be careful to avoid using any
...
void tc499_memory_initialize(void)
{
  /* SDRAM was initialized by a bootloader in the supported configurations. */
}

/****************************************************************************
 * Name: tc397_board_initialize
 *
 * Description:
 *   All i.MX6 architectures must provide the following entry point.  This
 *   entry point is called in the initialization phase -- after
 *   tc397_memory_initialize and after all memory has been configured and
...
void tc499_board_initialize(void)
{
