/****************************************************************************
 * boards/rh850/u2ax/u2a16icum/src/u2a16icum_boardinit.c
 *
...
/****************************************************************************
 * Name: u2a16icum_memory_initialize
 *
 * Description:
 ...
 *
 *   Logic in u2a16icum_memory_initialize must be careful to avoid using any
...
void u2a16icum_memory_initialize(void)
{
  /* SDRAM was initialized by a bootloader in the supported configurations. */
}

/****************************************************************************
 * Name: u2a16icum_board_initialize
 *
 * Description:
 *   All i.MX6 architectures must provide the following entry point.  This
 *   entry point is called in the initialization phase -- after
 *   u2a16icum_memory_initialize and after all memory has been configured and
...
void u2a16icum_board_initialize(void)
{
